...
class RNPushNotificationClass {
    ...
    PushNotification.configure({
      ...
      onNotification: (notification: any) => {
        ...
        if (notification.foreground) {
          ...
          const title = data.Nick;
          const message = data.Room;
          const channelId = 'default-channel-id';
          console.log('typeof data: ', typeof data);
          this.triggerLocalNotification(channelId, title, message);
  ...
  triggerLocalNotification = (
    ...
    console.log(soundName, title, content);
    ...
    PushNotification.localNotification({
      ...
      // message: content ? content : 'My Notification Message', // (required)
   ...
   */
  checkPermissions = (
    cb: (permissions: PushNotificationPermissions) => void,
  ) => {
